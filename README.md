...
https://github.com/harshavardhana-37/safety-risk-management-platform
...
```bash
git clone https://github.com/harshavardhana-37/safety-risk-management-platform.git
```

Go to the project folder:

```bash
cd safety-risk-management-platform
```
